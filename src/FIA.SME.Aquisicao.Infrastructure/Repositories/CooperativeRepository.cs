...
namespace FIA.SME.Aquisicao.Infrastructure.Repositories
{
    ...
    internal class CooperativeRepository : ICooperativeRepository
    {
        ...
        public async Task Save(Cooperative cooperative)
        {
            ...
            toSave.cnpj = cooperative.cnpj;
            toSave.cnpj_central = cooperative.cnpj_central;
            toSave.codigo_dap_caf = cooperative.dap_caf_code;
            toSave.email = cooperative.email;
            toSave.ip_aceite_termos_uso = cooperative.terms_use_acceptance_ip;
            toSave.razao_social = cooperative.name;
            toSave.sigla = cooperative.acronym;
            toSave.telefone = cooperative.phone;
