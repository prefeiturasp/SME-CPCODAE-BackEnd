...
namespace FIA.SME.Aquisicao.Api.Models
{
    public class PublicCallCooperativeInfoResponse
    {
        ...
        public PublicCallCooperativeInfoResponse(IPublicCallCooperativeAggregated cooperative, decimal total_delivered_percentage, List<PublicCallCooperativeDeliveryInfo> deliveries)
        {
            ...
            var inclusive_cooperative = cooperative.percentage_inclusiveness >= 50;
            ...
            this.classification = new CooperativeDeliveryInfoClassificationResponse(good_location, inclusive_cooperative, cooperative.proposal_is_organic, daps_percentage, cooperative.location_score, cooperative.percentage_inclusiveness, daps_percentage_proportion);
        ...
        {
            public CooperativeDeliveryInfoClassificationResponse(bool good_location, bool inclusive_cooperative, bool is_organic, bool daps_percentage, int location_score, decimal inclusive_cooperative_percentage, 
